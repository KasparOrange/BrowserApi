...
namespace BrowserApi.WebGpu
{
    ...
    public partial class GpuRenderBundleEncoder : JsObject
    {
        [JsName("label")]
        public string Label
        {
        ...
        [JsName("finish")]
        public GpuRenderBundle Finish(GpuRenderBundleDescriptor? descriptor = null) => Invoke<GpuRenderBundle>("finish", descriptor);
