...
{
    public partial class CanvasRenderingContext2D : JsObject
    {
        [JsName("canvas")]
        ...
        [JsName("drawFocusIfNeeded")]
        public void DrawFocusIfNeeded(Element element) => InvokeVoid("drawFocusIfNeeded", element);

        [JsName("drawFocusIfNeeded")]
        public void DrawFocusIfNeeded(Path2D path, Element element) => InvokeVoid("drawFocusIfNeeded", path, element);
