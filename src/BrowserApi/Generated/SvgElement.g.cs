...
namespace BrowserApi
{
    ...
    {
        [JsName("className")]
        public SvgAnimatedString ClassName => GetProperty<SvgAnimatedString>("className");

        [JsName("ownerSVGElement")]
        public SvgSvgElement? OwnerSvgElement => GetProperty<SvgSvgElement?>("ownerSVGElement");

        [JsName("viewportElement")]
        public SvgElement? ViewportElement => GetProperty<SvgElement?>("viewportElement");
        ...
        [JsName("correspondingElement")]
        public SvgElement? CorrespondingElement => GetProperty<SvgElement?>("correspondingElement");

        [JsName("correspondingUseElement")]
        public SvgUseElement? CorrespondingUseElement => GetProperty<SvgUseElement?>("correspondingUseElement");
